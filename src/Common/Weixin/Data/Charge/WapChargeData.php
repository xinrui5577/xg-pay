...
class WapChargeData extends ChargeBaseData
{
    ...
    protected function buildData()
    {
        ...
        $signData = [
            ...
            'notify_url'    => $this->notifyUrl.'/out_trade_no/'.$this->order_no,
        ...
        //$this->redirect_url= $this->redirect_url.'/out_trade_no/'.$this->order_no;
        // 移除数组中的空值
