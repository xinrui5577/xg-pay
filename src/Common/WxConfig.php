...
final class WxConfig extends ConfigInterface
{
    ...
    const RED_URL = '	https://api.mch.weixin.qq.com/{debug}/mmpaymkttransfers/sendredpack';
    ...
    public function __construct(array $config)
    {
        ...
        $this->cacertPath = "{$basePath}wx_cert.pem";
    }
    ...
    private function initConfig(array $config)
    {
        ...
        if(key_exists('wap_name', $config)){
            $this->wap_name = $config['wap_name'];
        }
        if(key_exists('wap_url', $config)){
            $this->wap_url = $config['wap_url'];
        }
    }
}
